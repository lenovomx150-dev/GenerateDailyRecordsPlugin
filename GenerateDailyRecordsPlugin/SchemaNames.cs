namespace GenerateDailyRecordsPlugin
{
    internal static class SchemaNames
    {
        ...
        {
            internal const string Name = "ucm_name", StateCode = "statecode", Facility = "ucm_facility", FacilityRecordFacility = "ucm_program", CensusDate = "createdon", DailyCensus = "ucm_dailycensus", LivingArea = "ucm_livingarea", UnitCensus = "ucm_unitcensus", FacilityRecord = "ucm_facilityrecord", Juvenile = "ucm_offendername", CurrentLivingArea = "ucm_currentlivingarealookup", FacilityRecordMovement = "ucm_jaillookup", Purpose = "ucm_purpose", AbsenceStart = "ucm_datetime", AbsenceEnd = "ucm_returnedtofacility", BjjsId = "ucm_juvenileid", PlacingCounty = "ucm_placingcounty", Billing = "ucm_billing", Date = "ucm_date", CensusCode = "ucm_reasonfornonbillable", ResidentsTotal = "ucm_totalresidents";
